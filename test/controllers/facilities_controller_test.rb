...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { legacy_id: @facility.legacy_id, name: @facility.name, ridb_id: @facility.ridb_id }
    end
  ...
  test "should update facility" do
    patch :update, id: @facility, facility: { legacy_id: @facility.legacy_id, name: @facility.name, ridb_id: @facility.ridb_id }
    assert_redirected_to facility_path(assigns(:facility))
  end
